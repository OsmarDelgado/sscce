  ...
  if ($model->load(Yii::$app->request->post()))
  {
   if ($model->validate())
   {
    ...
    if ($table->count() == 1)
    {
     ...
     $body .= "<p><a href='http://localhost/sscce/web/index.php?r=site/resetpass'>Recuperar password</a></p>";
    ...
    if (Yii::$app->request->get())
    {
        ...
        if ((int) $id)
        {
            ...
            if ($model->count() == 1)
            {
                ...
                if ($activar->update())
                {
                    echo "El registro se ha llevado a cabo correctamente, redireccionando ...";
  ...
  if ($model->load(Yii::$app->request->post()))
  {
   if($model->validate())
   {
    ...
    if ($table->insert())
    {
     ...
     $body .= "<a href='http://localhost/sscce/web/index.php?r=site/confirm&id=".$id."&authKey=".$authKey."'>Confirmar</a>";
